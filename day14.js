...
// console.log('Me last')
output me first . before b , me last , a , b
...
//     console.log('Me last')
// })
output me first ,a before b , b- me last
--------------------------------
...
Async await resolve the problem here :=
// prinAlphabets()
...
use the above code in this pr object
...
// ----------Prototypes built in by defaults
all methods it has and inherting from some parent object
...
// console.log(mouse.isTall)//undefined 
// console.log(rabbit.moves) // inherited property==move upto prototype chain
...
for (let key in rabbit){
    console.log(key)
}//both keys are visible of animal too here
...
//     this.firstName = name
//     this.isAdmin = true
//     // return this (implicit=happening outside and auto)
// }
